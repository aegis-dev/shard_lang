...
impl Opcode {
    pub fn from_string(value: &str) -> Option<Opcode> {
        return match value {
            ...
            "rmb_get" => Some(Opcode::RegMsbGet),
            "rlb_get" => Some(Opcode::RegLsbGet),
            "rmb_set" => Some(Opcode::RegMsbSet),
            "rlb_set" => Some(Opcode::RegLsbSet),
    ...
    pub fn to_string(&self) ->  &'static str {
        return match self {
            ...
            Opcode::RegMsbGet => "rmb_get",
            Opcode::RegLsbGet => "rlb_get",
            Opcode::RegMsbSet => "rmb_set",
            Opcode::RegLsbSet => "rlb_set",
            Opcode::Load8 => "load8",
